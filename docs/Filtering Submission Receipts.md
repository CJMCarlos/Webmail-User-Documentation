...
![alt text](assets/FilterSubmissionReciept.png"Annoying submission receipt email"){width=600px}
...
!!! success
    ...
    ![alt text](assets/FilterSuccess.png"Confirmation message showing filter creation success"){width=600px}
